...
def get_H_transform(A, nn, H0=None, gammas=None):
...
def subgraph_mp_transcription(nn: GNN, g, S: List, alpha: float = 0.0, gamma: List = None, verbose: bool = False, H=None, transforms=None):
